...
#FP16
/usr/src/tensorrt/bin/./trtexec --onnx=./detectaSombrero.onnx --explicitBatch --saveEngine=./detectaSombrero_fp16.trt --fp16
/usr/src/tensorrt/bin/./trtexec --explicitBatch --loadEngine=./detectaSombrero_fp16.trt --fp16
